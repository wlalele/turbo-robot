...
THREE.MD2CharacterComplex = function () {
	...
	this.update = function ( delta ) {
		...
		if ( this.controls ) this.updateMoves( this.controls.getObject() );
	...
	this.updateMovementModel = function ( delta ) {
		...
		if ( controls.moveRight() ) this.speed = THREE.Math.clamp( this.speed + delta * this.backAcceleration, this.maxReverseSpeed, this.maxSpeed );
		if ( controls.moveLeft() )  this.speed = THREE.Math.clamp( this.speed - delta * this.backAcceleration, this.maxReverseSpeed, this.maxSpeed );
